...
We welcome all contributions to mda-openbabel-converter!

Contributions can take many forms, such as:

* sharing bug reports or feature requests through the [Issue Tracker](https://github.com/lunamorrow/mda_openbabel_converter/issues)
...
The second two options both involve making a [pull request](https://github.com/lunamorrow/mda_openbabel_converter/pulls) .
