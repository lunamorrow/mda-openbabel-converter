...
To build mda-openbabel-converter from source,
...
Please cite [MDAnalysis](https://github.com/MDAnalysis/mdanalysis#citation) when using mda-openbabel-converter in published work.
